...
##            self.colorwin = colorwin            
    ...
    # ------WIDGETS DE MAIN WINDOW-------------------------------------------------------------------------------------------------------------------------------------------
        #                                                               FRAMES
    second_window = tk.Toplevel(root,bg="#091833")# 0
...
##    second_window.attributes('-fullscreen', True)
    ...
    second_window.focus_force()
    data_n_tree = tk.Frame(second_window, bg="#133e7c") # 1
    data_n_tree.grid(row=0,column=0,padx=(10,10),pady=(10,10))
    botones = tk.Frame(second_window, bg="#091833")# 1
    botones.grid(row=3,column=0,padx = (10,10),pady=(10,10))
    datos = tk.Frame(data_n_tree, bg="#133e7c")# 2
    datos.grid(row=0,column=0,padx = (10,10),pady=(10,10))
    d1 = tk.LabelFrame(datos,text="Datos del producto",bg=colores[0])
    d1.grid(row=0,column=0,padx = (10,10),pady=(10,10))
    d2 = tk.Frame(datos,bg="#0abdc6")
    d2.grid(row=1,column=0,padx = (10,10),pady=(10,10))
    ...
    d4.grid(row=6,column=0,padx = (10,10),pady=(10,10))
    d5 = tk.Frame(d3,bg="#0D5A58")
    d5.grid(row=1,column=0,padx = (10,10),pady=(10,10))
    d6 = tk.LabelFrame(d1,text="Envase",bg=colores[1])
    d6.grid(row=6,column=1,padx = (10,10),pady=(10,10))
    d7 = tk.LabelFrame(d1,text="Pictogramas (max 3)",bg=colores[1])# Checkbuttons for the pictogramas
    d7.grid(row=3,column=1,padx = (10,10),pady=(10,10))
    ...
    resultado = tk.Label(second_window, text="", pady=10,bg = "#091833", fg = "#ffffff")
    resultado.grid(row=1,column=0)
    resultado1 = tk.Label(second_window, text="", pady=10,bg = "#091833", fg = "#ffffff")
    ...
    lib = ttk.Button(option_frames[lista_opciones[0]],text="Libreria de Reactivos",command=libreac)
    lib.grid(row=row+len(specs), column=1)
    lib.bind("<Return>", on_enter)
    # --COMBOBOX------------------------------------------------OPCION 2-----------------------------------------------------------------------------------------
    ...
    addi = tk.Button(option_frames[lista_opciones[1]],text="agregar",command=agregar_paso)
    addi.grid(row=row+len(specs), column=0)
    addi.bind("<Return>", on_enter)
    # --COMBOBOX------------------------------------------------OPCION 3-----------------------------------------------------------------------------------------
    ...
    # BOTON QUE AGREGA EL TEXTO AL TREEVIEW
    adde = ttk.Button(option_frames[lista_opciones[2]],text="Agregar",command=agregar_banner)
    adde.grid(row=row+len(specs), column=0)
    adde.bind("<Return>", on_enter)
    visu = ttk.Button(option_frames[lista_opciones[2]],text="Visualizar",command=ver_banner)
    visu.grid(row=row+len(specs), column=1)
    visu.bind("<Return>", on_enter)
    sele = ttk.Button(option_frames[lista_opciones[2]], text="Seleccionar Imagen", command=seleccionar_imagen)
    sele.grid(row=row+len(specs), column=2)
    sele.bind("<Return>", on_enter)
    ...
    # AGREGAR AL TREEVIEW
    agregar_treeview = tk.Button(botones,text='Agregar  al treeview',command=agregar_treeview_func)
    agregar_treeview.grid(row=1,column=0)
    agregar_treeview.bind("<Return>", on_enter)
    # ELIMINAR EL ULTIMO ELEMENTO AÑADIDO AL TREEVIEW
    remove_button = tk.Button(botones, text="Quitar ultimo elemento", command=remove_last_item)
    remove_button.grid(row=1,column=1)
    remove_button.bind("<Return>", on_enter)
    ...
    show_button.bind("<Return>", on_enter)
    # CREAR EL EXCEL
    ex_button = tk.Button(botones, text="Crear el archivo EXCEL", command=excelizar)
    ex_button.grid(row=1,column=3)
    ex_button.bind("<Return>", on_enter)
    ...
    boton_vaciar.bind("<Return>", on_enter)
